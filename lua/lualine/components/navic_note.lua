...
local navic_note = require("navic_note")
...
local function adjust_hl(section)
  ...
  local lualine_bg = utils.extract_highlight_colors("lualine_" .. section .. suffix, "bg")
  local lualine_fg = utils.extract_highlight_colors("lualine_" .. section .. suffix, "fg")
...
function M:update_status()
  ...
  return navic_note.get_location(self.options.navic_opts)
end
